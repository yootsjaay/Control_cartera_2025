...
return new class extends Migration
{
 ...
 $table->foreignId('ramo_id')->constrained('ramos')->onDelete('cascade');
            ...
            $table->foreignId('user_id')->constrained('users')->onDelete('cascade'); // Clave foránea correcta
            ...
            $table->date('primer_pago_fraccionado')->nullable();
            $table->string('tipo_prima', 20);
