...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="m-0 text-dark text-center">Editar Compañía</h1>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><i class="fas fa-edit"></i> Editar</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card card-outline card-primary" style="max-width: 700px; margin: 0 auto;">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-edit mr-2"></i> Editar Compañía</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('companias.update', $compania->id) }}" method="POST">
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-save mr-2"></i> Actualizar Compañía
                    </button>
                </div>
            </form>
        </div>
