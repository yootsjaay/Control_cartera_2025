...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-sm-12">
            <h1 class="m-0 text-dark text-center">Crear Nuevo Seguro</h1>
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Nuevo Seguro</li>
            </ol>
        </div>
    </div>
    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form action="{{ route('seguros.store') }}" method="POST" id="seguroForm">
                @csrf
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        ...
                        <div id="ramos-container">
                            @if(old('ramos'))
                                @foreach(old('ramos') as $index => $ramo)
                            ...
                            @else
                                <div class="ramo-group input-group mb-2">
                                    <input type="text" name="ramos[0][nombre_ramo]" 
                                           class="form-control" 
                                           placeholder="Nombre del ramo"
                                           required>
                                    <div class="input-group-append">
                ...
                <div class="row mt-4">
                    <div class="col-12 text-right">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save mr-2"></i> Guardar Seguro
                        </button>
                    </div>
                </div>
            </form>
